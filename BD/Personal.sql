...
telefonocasa,celular,correo,nss,rfc,nivelmaxestudios,licenciatura,maestria,doctorado,r_puesto,status,tipoescuela) values 
...
2,1,1), ('Carlos Arturo','Ceron','Alvarez','1988-06-01','CELO857362HVZNRW03','Veracruz','Veracruz','Mexicano',1,'Veracruz',123,
'Veracruz',986541,'323437','2291841267','carlos.ceron@gmail.com','245328912','CELO757373','Doctorado','Sistemas','Ingenieria de sofware'
,'Ingenieria',2,1,1),('Luis Felipe','Marin','Urias','1988-11-12','LUFE857362HVZNRW03','Veracruz','Veracruz','Mexicano',1,'Veracruz',90,
...
2,1,1);
select * from tb_personal where tipoescuela = 1;
UPDATE `terranova`.`tb_personal` SET `nombre` = ?, `apellidopaterno` = ?, `apellidomaterno` = ?, `fechanacimiento` = ?, `curp` = ?, `municipionacimiento` = ?,
